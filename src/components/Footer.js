  ...
  return (
    <div className="font-poppins py-5 bg-yellow-50">
      <footer data-aos="zoom-in" className='container text-blue-200 mx-auto lg:px-20 font-russo px-5'>
        <div className="grid lg:grid-cols-4 grid-cols-1 items-center justify-between py-12 gap-y-8">

          <div className="flex flex-col gap-y-6 items-center justify-center lg:col-span-2">
            <div className="space-y-4 align-middle">

              <img src={logo} alt='' className='mb-3 flex mx-auto'></img>
              <a href='/' alt='krypto'>
